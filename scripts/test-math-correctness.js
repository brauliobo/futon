...
const CASES = [
  ...
  // Linear transformations + eigenvalues + parabola/conics + vector primitives
  { q: 'T(x,y)=(2x,3y): det([T]) = ?', a: '6', type: 'geometry', want: true },
  { q: 'T(x,y)=(2x,3y): T(4,5) — x-comp = ?', a: '8', type: 'geometry', want: true },
  { q: 'T(x,y)=(x+y, x-y): T(3,1) — x-comp = ?', a: '4', type: 'geometry', want: true },
  { q: 'T(x,y)=(x+y, x+y): det([T]) = ?', a: '0', type: 'geometry', want: true },
  { q: 'T linear → T(0) = ?', a: '0', type: 'geometry', want: true },
  { q: 'T∘T⁻¹ = ? (1=identidade)', a: '1', type: 'geometry', want: true },
  { q: 'Teorema rank-nulidade: dim ker + dim Im = dim domínio; T: R² → R²: dim ker + dim Im = ?', a: '2', type: 'geometry', want: true },
  { q: 'A=[2 1; 1 2]: polinômio λ²-4λ+3=0; λ₁ = ?', a: '1', type: 'geometry', want: true },
  { q: 'A=[2 1; 1 2]: λ₂ = ?', a: '3', type: 'geometry', want: true },
  { q: 'A=[1 2; 0 3]: autovalores: maior = ?', a: '3', type: 'geometry', want: true },
  { q: '(1/2)·(4,6) = ?', a: '(2, 3)', type: 'geometry', want: true },
  { q: 'Vetor oposto a (3,4) = ?', a: '(-3, -4)', type: 'geometry', want: true },
  { q: 'Vetor nulo = ?', a: '(0, 0)', type: 'geometry', want: true },
  { q: 'Unitário de (3,4) = ?', a: '(3/5, 4/5)', type: 'geometry', want: true },
  { q: 'u=(3,4), v=(4,3): u·v = ?', a: '24', type: 'geometry', want: true },
  { q: 'y=2x²-4x; vértice em x = -b/(2a) = ?', a: '1', type: 'geometry', want: true },
