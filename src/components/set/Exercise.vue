...
export default {
  ...
  computed: {
    ...
    inputClass() {
      const base = "w-full rounded-2xl border-4 px-4 py-4 text-xl font-bold placeholder:text-slate-300 focus:outline-none focus:ring-0 pr-12 transition-all duration-300";
