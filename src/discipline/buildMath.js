...
import level5ACount from "../levels/math/5A/count.json";
import level5ANextPrev from "../levels/math/5A/nextprev.json";
import level5AAddition1 from "../levels/math/5A/addition_1.json";
import level5AAddition2 from "../levels/math/5A/addition_2.json";
import level5AAddition3 from "../levels/math/5A/addition_3.json";
import level5AAddition4 from "../levels/math/5A/addition_4.json";
import level5AAddition5 from "../levels/math/5A/addition_5.json";
import level5AAddition6 from "../levels/math/5A/addition_6.json";
import level5AAddition7 from "../levels/math/5A/addition_7.json";
import level5AAddition8 from "../levels/math/5A/addition_8.json";
import level5AAddition9 from "../levels/math/5A/addition_9.json";
import level5ASubtraction1 from "../levels/math/5A/subtraction_1.json";
import level5ASubtraction2 from "../levels/math/5A/subtraction_2.json";
import level5ASubtraction3 from "../levels/math/5A/subtraction_3.json";
import level5ASubtraction4 from "../levels/math/5A/subtraction_4.json";
import level5ASubtraction5 from "../levels/math/5A/subtraction_5.json";
import level5ASubtraction6 from "../levels/math/5A/subtraction_6.json";
import level5ASubtraction7 from "../levels/math/5A/subtraction_7.json";
import level5ASubtraction8 from "../levels/math/5A/subtraction_8.json";
import level5ASubtraction9 from "../levels/math/5A/subtraction_9.json";
import level4ACount from "../levels/math/4A/count.json";
import level4AAddition from "../levels/math/4A/addition.json";
import level3AAddition from "../levels/math/3A/addition.json";
import level3ANextPrev from "../levels/math/3A/nextprev.json";
import level1AAddSub from "../levels/math/1A/add_sub_0_10.json";
import level1ANextPrev from "../levels/math/1A/nextprev_0_10.json";
import level2ASubtraction from "../levels/math/2A/subtraction.json";
import level2ASubtraction2 from "../levels/math/2A/subtraction_2.json";
