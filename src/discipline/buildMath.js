...
import level4ACount from "../levels/math/4A/count.yaml";
import level4AAddition from "../levels/math/4A/addition.yaml";
import level3AAddition from "../levels/math/3A/addition.yaml";
import level3ANextPrev from "../levels/math/3A/nextprev.yaml";
import level1AAddSub from "../levels/math/1A/add_sub_0_10.yaml";
import level1ANextPrev from "../levels/math/1A/nextprev_0_10.yaml";
import level2ASubtraction from "../levels/math/2A/subtraction.yaml";
import level2ASubtraction2 from "../levels/math/2A/subtraction_2.yaml";
